...
class Contacts extends Component {
    ...
    deleteContact = id => {
        const contactsCopy = [...this.state.contacts].splice(id, 1)
        ...
        return (
            <>
                <section>
                    ...
                    <button onClick={this.sortByName}>Order Alphabetically</button>
                    <button onClick={this.sortByPopularity}> Popular Order</button>
