...
class ContactList extends Component {
    ...
    render() {
        ...
        const listToShow = this.state.isSortedByName ? filteredContactsByName : this.state.isSortedByPopularity ? filteredContactsByPopularity : this.state.contactsShow
