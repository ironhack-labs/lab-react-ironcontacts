    ...
    <tbody key={obj.id}>
      <tr>
        <td style={{ textAlign: "left" }}>
          <img style={{ height: 100 }} src={obj.pictureUrl} alt="" />
        </td>
    ...
    <div>
      ...
      <table style={{ textAlign: "left" }}>
        <thead>
          <tr>
            <th style={{ width: 100 }}>
              <strong style={{ textAlign: "left" }}>Picture</strong>
            </th>
            <th style={{ width: 200 }}>
              <strong style={{ textAlign: "left" }}>Name</strong>
            </th>
            <th style={{ width: 200 }}>
              <strong style={{ textAlign: "left" }}>Popularity</strong>
            </th>
            <th style={{ width: 200 }}>
              <strong style={{ textAlign: "center" }}>Won Oscar</strong>
            </th>
            <th style={{ width: 200 }}>
              <strong style={{ textAlign: "center" }}>Won Emmy</strong>
            </th>
            <th style={{ width: 200 }}>
              <strong style={{ textAlign: "center" }}>Actions</strong>
            </th>
          </tr>
        </thead>
        {contactsTable}
