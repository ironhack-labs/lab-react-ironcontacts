  ...
  randomContact = () => {
   ...
   render() {
    ...
    return (
      <div>
        <h1>IronContacts</h1>
        <Button method={() => this.randomContact()}>Add Random Contact</Button>
        <Button method={() => this.sortName()}>Sort By Name</Button>
        <Button method={() => this.sortPopularity()}>Sort By Popularity</Button>
        <table>
          <tbody>
