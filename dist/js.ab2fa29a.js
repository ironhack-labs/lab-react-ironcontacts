...
},{"./cjs/react-dom.development.js":"../node_modules/react-dom/cjs/react-dom.development.js"}],"../contacts.json":[function(require,module,exports) {
module.exports = [{
  "name": "Idris Elba",
...
},{}],"js/components/Card.jsx":[function(require,module,exports) {
"use strict";
...
var Card = function Card(props) {
  return _react2.default.createElement(
    ...
    _react2.default.createElement("img", { src: props.pictureUrl, alt: "" }),
...
},{"react":"../node_modules/react/index.js"}],"js/Contacts.jsx":[function(require,module,exports) {
"use strict";
...
var _contacts = require("../../contacts.json");
...
var contactObj = JSON.stringify(_contacts2.default);
...
var Contacts = function (_Component) {
  ...
  function Contacts(props) {
    ...
    _this._addRandomContact = _this._addRandomContact.bind(_this);
    _this._deleteContact = _this._deleteContact.bind(_this);
    return _this;
  }
  ...
  _createClass(Contacts, [{
    ...
    value: function componentDidMount() {
      var firstFive = [];
      contactObj.forEach(function (contact, ind) {
        if (ind < 5) {
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              "button",
              { onClick: function onClick() {
                  return _this2._addRandomContact();
                } },
              "Add Random Contact"
            ),
            _react2.default.createElement(
            ...
            _react2.default.createElement(
              "button",
              { onClick: function onClick() {
                  return _this2._sortByPopularity();
                } },
              "Sort by popularity"
            )
          ),
          ...
          this.state.contacts.map(function (contact, ind) {
            return _react2.default.createElement(_Card2.default, {
              name: contact.name,
              pictureUrl: contact.pictureUrl,
              popularity: contact.popularity,
              deleteContact: _this2._deleteContact,
              index: ind
            });
          })
        )
    ...
    key: "_deleteContact",
    value: function _deleteContact(ind) {
    ...
    key: "_sortByName",
    value: function _sortByName() {
      var sortedArray = this.state.contacts;
    ...
    key: "_sortByPopularity",
    value: function _sortByPopularity() {
      var sortedArray = this.state.contacts;
      sortedArray.sort(function (a, b) {
    ...
    key: "_addRandomContact",
    value: function _addRandomContact() {
      var randomNumb = this._rn(contactObj.length);
      this.setState({
        contacts: [].concat(_toConsumableArray(this.state.contacts), [contactObj[randomNumb]])
      });
    }
  }, {
    key: "_rn",
    value: function _rn(max) {
...
},{"../../contacts.json":"../contacts.json","./components/Card":"js/components/Card.jsx","react":"../node_modules/react/index.js"}],"../node_modules/axios/lib/helpers/bind.js":[function(require,module,exports) {
'use strict';
...
},{"./lib/axios":"../node_modules/axios/lib/axios.js"}],"js/Application.jsx":[function(require,module,exports) {
"use strict";
...
},{"react":"../node_modules/react/index.js","./Contacts":"js/Contacts.jsx","axios":"../node_modules/axios/index.js"}],"js/index.js":[function(require,module,exports) {
'use strict';
...
},{"react-dom":"../node_modules/react-dom/index.js","react":"../node_modules/react/index.js","./Application":"js/Application.jsx"}],"../../../../../usr/local/lib/node_modules/parcel-bundler/lib/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../../../../../usr/local/lib/node_modules/parcel-bundler/lib/builtins/hmr-runtime.js","js/index.js"], null)
//# sourceMappingURL=/js.ab2fa29a.map