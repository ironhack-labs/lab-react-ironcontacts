...
class App extends Component {
  ...
  showContact = () => {
    console.log(
      "the current state when showing contacts ------- ",
      this.state.activeContacts
    );
    return this.state.activeContacts.map((eachContact, i) => {
      return (
        <IronContact
          key={i}
  ...
  getRandom() {
    ...
    this.setState({
      activeContacts: copyActiveArray,
      inactiveContacts: copyInactiveArray
    });
  }
