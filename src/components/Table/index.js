...
class Table extends Component{
    ...
    render() {
        ...
        return (
            <section>
                <button className="btn btn-outline-danger" onClick={this.randomContact}>Add Random Contacts</button>
                <button className="btn btn-outline-danger" onClick={this.sortName}>Sort by name</button>
                <button className="btn btn-outline-danger" onClick={this.sortPopularity}>Sort by Popularity</button>
